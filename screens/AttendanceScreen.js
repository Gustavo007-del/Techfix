...
<View style={styles.bottomNav}>
  <TouchableOpacity style={styles.navItem}>
    ...
    <Text style={[styles.navLabel, { color: COLORS.primary }]}>Attendance</Text>
  </TouchableOpacity>
  <TouchableOpacity 
    style={styles.navItem}
    onPress={() => navigation.navigate('SparePending')}
  >
    <MaterialIcons name="build" size={24} color={COLORS.gray} />
    <Text style={[styles.navLabel, { color: COLORS.gray }]}>Spares</Text>
  </TouchableOpacity>
  <TouchableOpacity 
    style={styles.navItem}
    onPress={() => navigation.navigate('MyRequests')}
  >
    <MaterialIcons name="list-alt" size={24} color={COLORS.gray} />
    <Text style={[styles.navLabel, { color: COLORS.gray }]}>Requests</Text>
  </TouchableOpacity>
  <TouchableOpacity style={styles.navItem}>
    <MaterialIcons name="notifications" size={24} color={COLORS.gray} />
    <Text style={[styles.navLabel, { color: COLORS.gray }]}>Alerts</Text>
  </TouchableOpacity>
  <TouchableOpacity style={styles.navItem}>
    <MaterialIcons name="account-circle" size={24} color={COLORS.gray} />
    <Text style={[styles.navLabel, { color: COLORS.gray }]}>Profile</Text>
  </TouchableOpacity>
</View>
    </View>
  );
